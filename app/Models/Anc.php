...
class Anc extends Model
{
    ...
    protected $fillable = ['token', 'woman_token', 'service_for', 'visit_date_np', 'visit_date', 'weight', 'anemia', 'swelling', 'blood_pressure', 'uterus_height', 'baby_presentation', 'baby_heart_beat', 'other', 'iron_pills', 'worm_medicine', 'td_vaccine', 'checked_by', 'hp_code', 'status', 'created_at', 'updated_at', 'situation']; // 24-28 weeks from lmp_date_en
