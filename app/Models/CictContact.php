...
class CictContact extends Model
{
    ...
    protected $fillable = [
        ...
        'healthworker_ppe', 'healthworker_first_date', 'healthworker_last_date', 'healthworker_narrative', 'healthworker_classify',
        ...
        'test_status', 'collection_date', 'test_type', 'result_date', 'followup_status',
        'completion_date'
    ];
}
