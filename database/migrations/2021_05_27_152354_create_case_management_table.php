...
class CreateCaseManagementTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('case_management', function (Blueprint $table) {
            ...
            $table->string('hp_code', 191)->nullable();
            ...
            $table->string('last_meet_date', 13)->nullable();
            ...
            $table->string('checked_by_name', 191)->nullable();
            $table->string('reference_date_from', 13)->nullable();
            $table->string('reference_date_to', 13)->nullable();
            $table->string('anyother_member_household', 5)->nullable();
            $table->string('total_member', 10)->nullable();
            ...
            $table->string('travel_date', 13)->nullable();
            $table->string('travel_route', 191)->nullable();
            $table->string('vehicle_no', 191)->nullable();
            $table->string('vehicle_seat_no', 191)->nullable();
            $table->string('taxi_no', 191)->nullable();
            $table->string('taxi_location', 191)->nullable();
            $table->string('flight_no', 191)->nullable();
            $table->string('flight_seat_no', 191)->nullable();
            ...
            $table->string('event_address', 191)->nullable();
            $table->string('event_phone', 191)->nullable();
            $table->string('event_date', 13)->nullable();
            $table->string('mention_detail', 191)->nullable();
            $table->string('case_direct_care', 5)->nullable();
            $table->string('case_direct_care_info', 191)->nullable();
            ...
            $table->string('first_product_name', 191)->nullable();
            $table->string('first_date_vaccination', 191)->nullable();
            ...
            $table->string('second_product_name', 191)->nullable();
            $table->string('second_date_vaccination', 191)->nullable();
            $table->string('second_source_info', 191)->nullable();
            $table->string('second_source_info_specific', 191)->nullable();
            $table->timestamps();
        });
    }
