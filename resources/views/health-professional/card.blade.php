        ...
        <div class="card-main-container">
            ...
            <div class="main1">
                ...
                <div class="container2">
                    ...
                    <p>
                    <p>पालिका : <b>{{ str_pad($data->municipality->municipality_name,  21, "___") ?? '' }}</b> वार्ड न :
                        <b>{{ $data->ward }}</b>
                    <p>
                    ...
                    <p class="signature">दस्तखत / ल्याप्चे <b>.............................</b>
                    <p>
            ...
            <div class="main2">
                ...
                <div class="container1">
                    ...
                    <p style="text-align: center; padding-bottom: 3em; padding-top: 1.5em;">दोश्रो पटक खोप लिन आँउदा यो
                        कार्ड अनिवार्य रुपमा लिएर आउनुपर्दछ ।</p>
                </div>
            </div>
        </div>
    </div>
