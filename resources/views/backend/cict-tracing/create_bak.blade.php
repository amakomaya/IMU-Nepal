...
@section('style')
<link href="{{ asset('css/cict.css') }}" rel="stylesheet">
@endsection
...
<div id="page-wrapper">
    ...
    <div class="investigation-form">
        ...
        <div style="padding-left: 0.5em;">
            <input style="padding-left: 0.5em;" type="radio" id="probable-case" name="case_what" value="1" />
            <label for="probable-case"> Probable case</label>
        </div>
        <div style="padding-left: 0.5em;">
            <input style="padding-left: 0.5em;" type="radio" id="confirmed-case*" name="case_what" value="2"/>
            <label for="confirmed-case*"> Confirmed case</label>
        </div>

        <p style="padding-left: 0.5em;"></p>
        <div class="info">
            <label>Date of case received by health authority:</label>
            <u>{{ $patient->latestAnc->collection_date_np }}</u><br>
            <label>Date of CICT initiated:</label>
            <input type="text" name="initiated_date_np" class="form-control" id="initiated_date_np">
            <label>Name and Address of the reporting Institution:</label>
            <input type="text" name="institution_details" class="form-control">
        </div>
        ...
        <section class="section-1">
            ...
            <div class="info-personal">
                <div class="pi-1">
                    ...
                    <div class="date">
                        <p style="padding-right: 2em !important;">Age: <u>{{ $patient->age }}</u></p>
                        <p style="padding-right: 2em !important;">
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" @if($patient->age_unit == 0) checked @endif disabled >
                                <label for="Years"> Years</label>
                            </div>
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" @if($patient->age_unit == 1) checked @endif disabled >
                                <label for="Months"> Months</label>
                            </div>
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" @if($patient->age_unit == 2) checked @endif disabled >
                                <label for="Unknown"> Days</label>
                            </div>
                        </p>
                    </div>
                    <p>Contact number: <u>{{ $patient->emergency_contact_one }}</u></p>
                </div>
                <div class="pi-2">
                    <p>Name: <u>{{ $patient->name }}</u></p>
                    <div style="display: flex; flex-direction: row;">
                            <p>Sex:</p>
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" id="Male"  @if($patient->sex == 1) checked @endif disabled ">
                                <label for="Male"> Male</label>
                            </div>
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" id="Female"  @if($patient->sex == 2) checked @endif disabled >
                                <label for="Female"> Female</label>
                            </div>
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" id="Unknown"  @if($patient->sex == 3) checked @endif disabled >
                                <label for="Unknown"> Unknown</label>
                            </div> 
                        </div>
                    <p>Nationality: <u>{{ $patient->nationality }}</u></p>
                    <p>Alternate contact number: <u>{{ $patient->emergency_contact_two }}</u></p>
                </div>
            </div>
            <sub-section>
                ...
                <table>
                    <tr>
                        <td>Province: <u>{{ $patient->province->province_name }}</u></td>
                        <td colspan="2">District: <u>{{ $patient->municipality->district_name }}</u></td>
                    </tr>
                    <tr>
                        <td>
                            Municipality: <u>{{ $patient->municipality->municipality_name }}</u> <br />
                            <p>If information is given by any other than case,</p>
                            <label>Name of the informant:</label>
                            <input type="text" name="informant_name" class="form-control" id="informant_name">
                        </td>
                        <td>
                            <p>Ward No: {{ $patient->ward }}</p>
                            <label>Relationship: </label>
                            <input type="text" name="informant_relation" class="form-control" id="informant_relation">
                        </td>
                        <td>
                            <p>Tole/Landmark: {{ $patient->tole }} </p>
                            <label>Contact no: </label>
                            <input type="text" name="informant_contact" class="form-control" id="informant_contact">
                        </td>
                    </tr>
                    <tr>
                        <td>
...
$('#initiated_date_np').nepaliDatePicker({
    language: 'english',
