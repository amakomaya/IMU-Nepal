...
<div id="page-wrapper">
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-8 form-group">
            ...
            <select placeholder="Type Lab Name to search informations ..">
    ...
    <header>
        ...
        <div class="side-header">Unique ID (in IMU app): </div>
    </header>
        ...
        <section class="section-1">
            ...
            <div class="info-personal">
                <div class="pi-1">
                    ...
                    <div class="date">
                        <p style="padding-right: 2em !important;">Age: <u></u></p>
                        <p style="padding-right: 2em !important;">
                            <div style="padding-left: 1em;">
                                <input style="padding-left: 0.5em;" type="checkbox" name="age_unit" value="" >
