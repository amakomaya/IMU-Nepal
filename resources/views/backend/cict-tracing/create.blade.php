                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="control-group">
                                    <label class="radio-inline" style="padding-right: 60px;">
                                        <h4>Probable case</h4>
                                        <input type="radio" name="case_what" value="1" class="case_what" required style="top: 7px;">
                                    </label>
                                    <label class="radio-inline">
                                        <h4>Confirmed case</h4>
                                        <input type="radio" name="case_what" value="2" class="c" style="top: 7px;">
                                    </label>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('case_epi_id') ? 'has-error' : '' }}">
                                <label for="case_epi_id">Case Epi ID</label>
                                <input type="text" id="case_epi_id" class="form-control" value="{{ old('case_epi_id') }}" name="case_epi_id"
                                       aria-describedby="help" placeholder="Enter Case Epi ID">
                                @if ($errors->has('case_epi_id'))
                                    <small id="help" class="form-text text-danger">{{ $errors->first('case_epi_id') }}</small>
                                @endif
                            </div>
