                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="caste" class="form-control">
                                    <option {{ old('caste') == '7' ? "selected" : "" }} value="6">Don't Know</option>
                                    <option {{ old('caste') == '1' ? "selected" : "" }} value="0">Dalit</option>
                                    <option {{ old('caste') == '2' ? "selected" : "" }} value="1">Janajati</option>
                                    <option {{ old('caste') == '3' ? "selected" : "" }} value="2">Madheshi</option>
                                    <option {{ old('caste') == '4' ? "selected" : "" }} value="3">Muslim</option>
                                    <option {{ old('caste') == '5' ? "selected" : "" }} value="4">Brahmin/Chhetrai
                                    </option>
                                    <option {{ old('caste') == '6' ? "selected" : "" }} value="5">Other</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group {{ $errors->has('date_of_onset_of_first_symptom') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $dateToday }}"
