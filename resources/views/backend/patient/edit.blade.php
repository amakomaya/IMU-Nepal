                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="caste" class="form-control">
                                        <option {{ $data->caste == '7' ? "selected" : "" }} value="6">Don't Know
                                        </option>
                                        <option {{ $data->caste == '1' ? "selected" : "" }} value="0">Dalit</option>
                                        <option {{ $data->caste == '2' ? "selected" : "" }} value="1">Janajati</option>
                                        <option {{ $data->caste == '3' ? "selected" : "" }} value="2">Madheshi</option>
                                        <option {{ $data->caste == '4' ? "selected" : "" }} value="3">Muslim</option>
                                        <option {{ $data->caste == '5' ? "selected" : "" }} value="4">Brahmin/Chhetrai
                                        </option>
                                        <option {{ $data->caste == '6' ? "selected" : "" }} value="5">Other</option>
                                    </select>
                                </div>
                                <div class="form-group">
