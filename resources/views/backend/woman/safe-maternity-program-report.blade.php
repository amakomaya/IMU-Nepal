<div class="print" id="printable">
    <style type="text/css">
        ...
        .report{margin:5px; float: left; width:48%;}
        .titleHeader{border:1px solid #000;text-align: center; padding:5px;background-color: #dfdfdf; font-size:14px; margin-right:3%; margin-top: 5px !important;}
        .report, .report td, .report th {border: 1px solid black; border-collapse: collapse;}
        .report th{font-size: 14px; padding:5px;background-color:#dfdfdf;}
        .report td{font-size: 14px;padding:10px;color:#000;}
        .clearfix{clear: both;}
      </style>
      <div style="float: right; text-align: right; font-size: 12px; margin-right:4%;">HMIS 9.3</div>
