...
export default {
  ...
  created: function () {
    let url = window.location.protocol + '/data/api/admin/dashboard-old';
    axios.get(url)
        .then((response) => {
  ...
  methods: {
    ...
    //     let url = window.location.protocol + '/data/api/admin/dashboard-old?date_selected=' + this.initialApiParam;
    //     axios.get(url)
    //         .then((response) => {
    //           this.report = response.data;
    //         })
