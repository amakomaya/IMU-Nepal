  ...
  <div>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr v-if="checkPermission('lab-result') && checkPermission('lab-received')">
...
export default {
  ...
  methods: {
    ...
    submitBulkLabResultFile(){
      ...
      axios.post( '/api/v1/bulk-upload/lab-result',
        formData,
        {
          headers: {
      ...
      .catch(function(err){
        ...
        if(err.response.status===500) {
          ...
          errorMsg = 'The Lab Results could not be uploaded due to the following problems: \n';
    ...
    submitBulkLabReceivedFile(type){
      ...
      axios.post( '/api/v1/bulk-upload/lab-received',
        formData,
        {
          headers: {
              'Content-Type': 'multipart/form-data'
      ...
      .catch(function(err){
        ...
        if(err.response.status===500) {
          ...
          errorMsg = 'The Lab Received could not be uploaded due to the following problems: \n';
    ...
    submitBulkRegistrationSampleCollectionFile(type){
      ...
      formData.append('bulk_file_lab_received_result', this.bulk_file_lab_received_result);
      axios.post( '/api/v1/bulk-upload/lab-received-result',
        formData,
        {
          headers: {
              'Content-Type': 'multipart/form-data'
      ...
      .catch(function(err){
        ...
        if(err.response.status===500) {
          ...
          errorMsg = 'The Lab Received & Lab Result could not be uploaded due to the following problems: \n';
    ...
    submitBulkRegistrationSampleCollectionFile(type){
      ...
      formData.append('bulk_file_registration_sample_collection', this.bulk_file_registration_sample_collection);
      axios.post( '/api/v1/bulk-upload/registration-sample-collection',
        formData,
        {
          headers: {
              'Content-Type': 'multipart/form-data'
      ...
      .catch(function(err){
        ...
        if(err.response.status===500) {
          ...
          errorMsg = 'The Sample Collection could not be uploaded due to the following problems: \n';
    ...
    submitBulkRegistrationSampleCollectionLabTestFile(type){
      ...
      formData.append('bulk_file_registration_sample_collection_lab_test', this.bulk_file_registration_sample_collection_lab_test);
      axios.post( '/api/v1/bulk-upload/registration-sample-collection-lab-test',
        formData,
        {
          headers: {
              'Content-Type': 'multipart/form-data'
