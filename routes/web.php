...
Route::get('/admin/cict-tracing/municipality-report', 'Backend\CictTracingController@municipalityReport')->name('cict-tracing.municipality-report')->middleware('role-control:municipality');
