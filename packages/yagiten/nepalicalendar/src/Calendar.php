...
namespace Yagiten\Nepalicalendar;
	...
	class Calendar
	{
		...
		private static $_nep_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'nmonth' => '', 'num_day' => '');
		private static $_eng_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'emonth' => '', 'num_day' => '');
		public $debug_info = "";
		/**
		 * Return day
		 *
		...
		public static function eng_to_nep($yy, $mm, $dd)
		{
			...
			$chk = static::_is_in_range_eng($yy, $mm, $dd);
			if($chk !== TRUE)
			{
				die($chk);
			}
			else
			{
				...
				{
					if (static::is_leap_year($def_eyy + $i) === TRUE)
					{
						for ($j = 0; $j < 12; $j++)
						{
				...
				for ($i = 0; $i < ($mm - 1); $i++)
				{
					if (static::is_leap_year($yy) === TRUE)
					{
				...
				$numDay = $day;
				static::$_nep_date['year']    = $y;
				static::$_nep_date['month']   = sprintf("%02d", $m);
				static::$_nep_date['date']    = sprintf("%02d", $total_nDays);
				static::$_nep_date['day']     = static::_get_day_of_week($day);
				static::$_nep_date['nmonth']  = static::_get_nepali_month($m);
				static::$_nep_date['num_day'] = $numDay;
				return new static;
			}
		...
		public static function nep_to_eng($yy, $mm, $dd)
		{
			...
			// Check for date range
			$chk = static::_is_in_range_nep($yy, $mm, $dd);
			if ( $chk !== TRUE)
			{
				die($chk);
			}
			else
			{
				...
				$numDay = $day;
				static::$_eng_date['year']    = $y;
				static::$_eng_date['month']   = sprintf("%02d", $m);
				static::$_eng_date['date']    = sprintf("%02d", $total_eDays);
				static::$_eng_date['day']     = static::_get_day_of_week($day);
				static::$_eng_date['nmonth']  = static::_get_english_month($m);
				static::$_eng_date['num_day'] = $numDay;
				return new static;
		...
		public function getYearMonthDay(){
			if(self::$_nep_date['year']!=""){
				$_nep_date = self::$_nep_date;
				return $date = $_nep_date['year']."-".$_nep_date['month']."-".$_nep_date['date'];
			}
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['year']."-".$_eng_date['month']."-".$_eng_date['date'];
			}
		}



		public function getYearMonthDayNepToEng(){
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['year']."-".$_eng_date['month']."-".$_eng_date['date'];
			}
		...
		public function getYearMonthDayEngToNep(){
			if(self::$_nep_date['year']!=""){
				$_nep_date = self::$_nep_date;
				return $date = $_nep_date['year']."-".$_nep_date['month']."-".$_nep_date['date'];
			}
		...
		public function getDayMonthYearNepToEng(){
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['date']."/".$_eng_date['month']."/".$_eng_date['year'];
			}
		}
		...
		public function getDayMonthYear(){
			if(self::$_nep_date['year']!=""){
				$_nep_date = self::$_nep_date;
				return $date = $_nep_date['date']."/".$_nep_date['month']."/".$_nep_date['year'];
			}
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['date']."/".$_eng_date['month']."/".$_eng_date['year'];
		...
		public function getYear(){
			if(self::$_nep_date['year']!=""){
				$_nep_date = self::$_nep_date;
				return $date = $_nep_date['year'];
			}
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['year'];
			}
		}
		...
		public function getMonth(){
			if(self::$_nep_date['year']!=""){
				$_nep_date = self::$_nep_date;
				return $date = $_nep_date['month'];
			}
			if(self::$_eng_date['year']!=""){
				$_eng_date = self::$_eng_date;
				return $date = $_eng_date['month'];
			}
		}
	...
	/* Example 
	*	echo Calendar::eng_to_nep(2018,01,03)->getYearMonthDay();
	*	echo Calendar::nep_to_eng(2074,09,19)->getYearMonthDay();
	*/
